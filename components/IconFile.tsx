...
interface IconFileSvgProps{
    color: string
}

export default function IconFile({color} : IconFileSvgProps){
    return  <svg width={ICON_SIZES.medium} height={ICON_SIZES.medium} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
